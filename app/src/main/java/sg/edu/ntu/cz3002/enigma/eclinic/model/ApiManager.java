...
public class ApiManager {
    ...
    public Observable<ResponseBody> sendProgress(String doctor, String patient, String progress) {
        return _apiService.sendProgress(new Progress(doctor, patient, progress));
    }
